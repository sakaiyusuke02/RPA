...
namespace オブジェクトリポジトリ.ObjectRepository
{
    public static class Descriptors
    {
        public static class 新しいアプリケーション
        {
        }

        public static class 条件分岐
        {
        }
    }
}

namespace オブジェクトリポジトリ._Implementation
{
